  ...
  if (compact) {
    return (
      <button
        ...
        aria-label={label}
        title={label}
        style={{ background: colors.background, color: colors.color, borderLeftColor: colors.band }}
        className="flex w-full items-center gap-1 truncate rounded-[3px] border-l-2 px-1 py-px text-left text-[10px] leading-[1.35] font-semibold"
      >
